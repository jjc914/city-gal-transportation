...
export default async function contactUs(req, res) {
    ...
    if (req.method === 'POST') {
        bodyParser.urlencoded({ extended: true }) (req, res, () => {
            ...
            let checked = true;
            console.log(body['is-rideshare']);

            let html = `
            <body>
              <div style="overflow: hidden; background-color: white; width: fit-content; height: fit-content; margin: auto; font-size: 1em;">
                <table style="border-spacing: 10px; width: 100%;">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <table style="width: 10%; height: fit-content; background-color: #fff3f2; padding: 10px; border: 1px solid #afafaf;">
                          <tbody>
                            <tr>
                              <td>
                              ...
                              <td>
                                <table style="width: 400px;">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>
                                        <div style="display: inline-block; width: 80px; height: 30px; line-height: 30px; background-color: white; border-radius: 3px; font-family: Georgia,Times New Roman,Times,serif; font-size: 1em; padding: 0px 10px 0px 10px; border: 1px solid #cfcfcf;">${body['flight']}</div>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td style="font-size: 0.8em; font-weight: 600;">
                                <input style="display: inline; vertical-align: middle;" disabled="disabled" type="checkbox" ${checked}>
